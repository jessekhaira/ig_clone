...
#navbar #navbar_options #profile_settings {
  position: absolute;
  top: 45px;
  right: -8px;
  height: 190px;
...
#navbar #navbar_options #profile_settings::after {
  z-index: -20;
  content: "";
  position: absolute;
  width: 10px;
...
#navbar #navbar_options #profile_settings::before {
  z-index: 20;
  content: "";
  position: absolute;
  width: 0;
...
#navbar .profile_settings_options {
  display: flex;
...
#navbar .profile_settings_options .profile_settings_icons {
  display: flex;
  justify-content: center;
  align-items: center;
  margin-right: 12px;
}
#navbar .profile_settings_options .profile_settings_descr {
  display: flex;
  justify-content: center;
  align-items: center;
}
#navbar .profile_settings_options:hover {
  background-color: var(--main-bg-color);
  z-index: 50;
}
#navbar #log_out_div .logout {
  margin-left: 5px;
}
#navbar #hr_settings {
  height: 1px;
